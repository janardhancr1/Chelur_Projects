<%@ Page Language="C#" MasterPageFile="~/PAMaster.master" AutoEventWireup="true"
    CodeFile="MonthlyLedger.aspx.cs" Inherits="MonthlyLedger" %>
    ...
    <table width="100%" id="DetailsTable" runat="server">
        ...
        <tr>
            <td colspan="4" align="center">
                ...
                <input id="Button1" type="button" value="Close" runat="server" onclick="window.location.href='Ledgers.aspx';" />
            </td>
        </tr>
    </table>
    <input type="hidden" id="LedgerID" runat="server" />
    <input type="hidden" id="Ledger" runat="server" />
</asp:Content>
