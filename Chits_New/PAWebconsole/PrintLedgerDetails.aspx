<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintLedgerDetails.aspx.cs"
    Inherits="PrintLedgerDetails" %>
    ...
    <form id="form1" runat="server">
        <div>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="Reports\LedgerPrint.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetPrintLedger"
                TypeName="PALibrary.Library.Component.AccountsManager">
                <SelectParameters>
                    <asp:Parameter DefaultValue="" Name="fromDate" Type="DateTime" />
                    <asp:Parameter DefaultValue="" Name="toDate" Type="DateTime" />
                    <asp:Parameter DefaultValue="" Name="ledgerID" Type="Int32" />
                    <asp:Parameter DefaultValue="" Name="ledgerName" Type="String" />
                    <asp:Parameter DefaultValue="" Name="type" Type="Int32" />
                </SelectParameters>
            </asp:ObjectDataSource>
        </div>
        <input type="hidden" id="FromDate" runat="server" />
        <input type="hidden" id="ToDate" runat="server" />
        <input type="hidden" id="LedgerName" runat="server" />
