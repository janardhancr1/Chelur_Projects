<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintProfitLoss.aspx.cs"
    Inherits="PrintProfitLoss" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <LocalReport ReportPath="Reports\ProfitLoss.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DayBookInfo" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetProfitLoss"
