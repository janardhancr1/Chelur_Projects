<%@ Page Language="C#" MasterPageFile="~/PAMaster.master" AutoEventWireup="true"
    CodeFile="ViewLedger.aspx.cs" Inherits="ViewLedger" %>
    ...
    <table width="100%">
        <tr>
            <td width="15%">
                Select Ledger:</td>
            <td width="15%">
                <asp:DropDownList ID="LedgerName" runat="server" Width="153px" AutoPostBack="true" OnSelectedIndexChanged="LedgerName_Selected">
                </asp:DropDownList></td>
