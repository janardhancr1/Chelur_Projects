<%@ Page Language="C#" MasterPageFile="~/PAMaster.master" AutoEventWireup="true"
    CodeFile="PrintATKT.aspx.cs" Inherits="PrintATKT" %>
     ...
     function openReport(type)
       {
            ...
            {             
                var win = window.open('PrintATKTReport.aspx?fromdate=' + fromDate + '&todate=' + toDate + '&closed=' + closed, 'RepoWind', 'top=100,left=250,height=600,width=600,status=yes,resizable=yes');
                win.focus();
            }
       }
    </script>
    ...
    <table class="data_table" width="98%" align="center">
        <tr>
            ...
            <td width="20%">
                ...
                <input type="button" value="Close" onclick="window.location.href='ATKT.aspx';" />
            </td>
        </tr>
        <tr class="nav_header">
            <td colspan="6">
