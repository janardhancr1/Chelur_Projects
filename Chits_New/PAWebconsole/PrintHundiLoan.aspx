<%@ Page Language="C#" MasterPageFile="~/PAMaster.master" AutoEventWireup="true"
    CodeFile="PrintHundiLoan.aspx.cs" Inherits="PrintHundiLoan" %>
     ...
     function openReport(type)
       {
            ...
            {             
                var win = window.open('PrintHundiLoanReport.aspx?fromdate=' + fromDate + '&todate=' + toDate + '&closed=' + closed + '&sort=' + sort, 'RepoWind', 'top=100,left=250,height=600,width=600,status=yes,resizable=yes');
                win.focus();
            }
       }
    </script>
