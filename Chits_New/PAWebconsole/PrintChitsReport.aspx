<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintChitsReport.aspx.cs"
    Inherits="PrintChitsReport" %>
...
<head runat="server">
    <title>Chits Report</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" Width="100%">
                <LocalReport ReportPath="Reports\ChitsReport.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="ChitsInfo" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetChitsInfos"
                TypeName="PALibrary.Library.Component.ChitsManager">
                <SelectParameters>
