...
namespace PALibrary.Library.Model
{
    public class ChitsBiddingInfo
    {
        ...
        public const string QUERY_INSERT = "INSERT INTO " + TABLE_NAME + "(Record_ID,Chit_No,Installment_No,Paid_Amount,Paid_Date,Customer_ID,Left_Amount) VALUES (" + PARAM_RECORD_ID + "," + PARAM_CHIT_NO + "," + PARAM_INSTALLMENT_NO + "," + PARAM_PAID_AMOUNT + "," + PARAM_PAID_DATE + "," + PARAM_CUSTOMER_ID + "," + PARAM_LEFT_AMOUNT + ")";
        public const string QUERY_UPDATE = "UPDATE " + TABLE_NAME + " SET Chit_No=" + PARAM_CHIT_NO + ",Installment_No=" + PARAM_INSTALLMENT_NO + ",Paid_Amount=" + PARAM_PAID_AMOUNT + ",Paid_Date=" + PARAM_PAID_DATE + ",Customer_ID=" + PARAM_CUSTOMER_ID + ",Left_Amount=" + PARAM_LEFT_AMOUNT + " WHERE Record_ID=" + PARAM_RECORD_ID;
        public const string QUERY_DELETE = "DELETE FROM " + TABLE_NAME + " WHERE Record_ID=" + PARAM_RECORD_ID;

        public const string QUERY_SEARCH = "SELECT Record_ID,Chit_No,Installment_No,Paid_Amount,Paid_Date,Customer_ID,Left_Amount FROM " + TABLE_NAME;
        public const string QUERY_COUNT = "SELECT Count(*) FROM " + TABLE_NAME;

        public const string QUERY_SELECT = "SELECT Record_ID,Chit_No,Installment_No,Paid_Amount,Paid_Date,Customer_ID,Left_Amount FROM " + TABLE_NAME + " WHERE Record_ID=" + PARAM_RECORD_ID;
        public const string QUERY_SELECT_ALL = "SELECT Record_ID,Chit_No,Installment_No,Paid_Amount,Paid_Date,Customer_ID,Left_Amount FROM " + TABLE_NAME;
