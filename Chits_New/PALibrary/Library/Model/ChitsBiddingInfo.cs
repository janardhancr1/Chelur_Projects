...
namespace PALibrary.Library.Model
{
    public class ChitsBiddingInfo
    {
        ...
        public const string QUERY_SELECT_PERIOD_ALL = "SELECT Record_ID,b.Chit_No,Installment_No,Paid_Amount,b.Bid_Date,Paid_Date,b.Customer_ID,Left_Amount,c.Chit_Name FROM " + TABLE_NAME + " b, chits c WHERE b.Chit_No=c.Chit_No AND Customer_ID>0  AND Paid_Date>=" + PARAM_FROM_DATE + " AND Paid_Date<=" + PARAM_TO_DATE + " ORDER BY Paid_Date";
